...
available from the [Unity Beta Program site](https://unity3d.com/unity/beta#download) soon.
...
POI billboard .png files or batch create all POI files when necessary. The current POI files included within 
