...
/// </summary>
public class Interactive : MonoBehaviour, IMixedRealityFocusChangedHandler, IMixedRealityFocusHandler, IMixedRealityInputHandler//, IInputClickHandler, IFocusable, IInputHandler
{
